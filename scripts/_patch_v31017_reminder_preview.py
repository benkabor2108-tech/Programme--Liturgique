...
preview = (
    ...
    '            st.info(\\n'
    '                f"Prochain week-end liturgique : dimanche {_wa_preview_summary[\'weekend_label\']} · "\\n'
    '                f"rappel mercredi {_wa_preview_summary[\'wednesday_label\']} · "\\n'
    '                f"rappel vendredi {_wa_preview_summary[\'friday_label\']}."\\n'
    '            )\\n'
    ...
    '            )\\n'
    '            st.caption(\\n'
    '                "Aucun message n\\\'est envoyé depuis cet aperçu. Il reproduit uniquement le plan "\\n'
