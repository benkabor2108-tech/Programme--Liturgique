...
class WhatsAppUiGuardTests(unittest.TestCase):
    ...
    def test_wrapper_adds_weekend_contact_readiness_dashboard(self):
        ...
        self.assertIn("Célébrations futures", WRAPPER)
        self.assertIn('_wa_summary["celebrations"]', WRAPPER)
